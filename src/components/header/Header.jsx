    ...
    return (
        <header className="header mw1200">
            ...
            <div className="header__right">
                ...
                <div className="header__emergency">
                    <span className="header__emergency-icon">
                    ...
                    <div className="header__emergency-info">
                        <div className="header__emergency-top">24/7 Emergency Call</div>
                        <div className="header__emergency-number">123-456-7890</div>
                    </div>
                </div>
